...
func (c *googleClient) Watch(ctx context.Context, in *Request, opts ...grpc.CallOption) (Google_WatchClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Google_serviceDesc.Streams[0], c.cc, "/google_svc.Google/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	0xec, 0xc5, 0x79, 0x99, 0x05, 0x05, 0xa9, 0x25, 0x12, 0xcc, 0x60, 0x51, 0x18, 0xd7, 0xa8, 0x98,
	0x8b, 0xcd, 0x1d, 0x6c, 0xb5, 0x90, 0x31, 0x17, 0x5b, 0x70, 0x6a, 0x62, 0x51, 0x72, 0x86, 0x90,
	0xb0, 0x1e, 0xc2, 0x35, 0x7a, 0x50, 0xa7, 0x48, 0x09, 0xa1, 0x0a, 0x82, 0xac, 0x57, 0x62, 0x10,
	0x32, 0xe1, 0x62, 0x0d, 0x4f, 0x2c, 0x21, 0x49, 0x8f, 0x01, 0x63, 0x12, 0x1b, 0xd8, 0xd3, 0xc6,
	0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xc7, 0xb4, 0x3f, 0xc4, 0x04, 0x01, 0x00, 0x00,
}
